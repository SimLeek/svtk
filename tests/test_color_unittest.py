...
class TestColor(unittest.TestCase):
    ...
    def test_float_to_char(self):
        seq1 = [178, 255, 51, 127]
        seq2 = c.float_to_char(np.array([0.7, 1.1, 0.2, 0.5]))
    ...
    def test_char_to_float(self):
        seq1 = [0.7, 0.35, 0.2, 0.5]
        seq2 = c.char_to_float(c.float_to_char(np.array([0.7, 0.35, 0.2, 0.5])))
        self.assertAlmostEqual(seq1[0], seq2[0], delta=0.02)
        self.assertAlmostEqual(seq1[1], seq2[1], delta=0.02)
        self.assertAlmostEqual(seq1[2], seq2[2], delta=0.02)
        self.assertAlmostEqual(seq1[3], seq2[3], delta=0.02)
